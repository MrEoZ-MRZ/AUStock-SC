...
public class Database extends AsyncTask<String, Void, String> {
    ...
    public Database(MainActivity activity){
    ...
    protected void onPostExecute(String s) {
        ...
        String v3 = Environment.getExternalStorageDirectory().getPath() + "/AUStock/Databases/";
        File databas = new File(v3 + DATABASE_NAME);
        String database = encodeFileToBase64(databas);
        Preferencias.with(getActivity()).write("MYDB", database);
